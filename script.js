document.addEventListener('DOMContentLoaded', () => {
    ...
    const cowText = document.getElementById('cow-text');
    ...
    function startCowGame() {
        ...
        scoreInterval = setInterval(() => {
            ...
            if (cowScore >= requiredCowScore) {
                alert('Hurra! Zdobyłeś 200 punktów! Czas na niespodziankę!');
                endCowGame();
            }
        }, 100);
    }
    ...
    function checkWin() {
        if (poppedBalloons >= totalBalloons) {
            ...
            cowImage.classList.remove('hidden');
    ...
    // Initially hide the birthday message and cow elements
    birthdayMessage.classList.add('hidden');
    cowImage.classList.add('hidden');
    cowText.classList.add('hidden');
